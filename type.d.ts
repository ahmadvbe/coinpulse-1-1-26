//30:58 define tbhe type of all these properties @ coinpulse/type.d.ts which will be passed 
//@ coinpulse/components/DataTable.tsx
  //d stands for declaration , we wana declare all of our types
//define different interfaces object like types
// begin with 31:40 interface DataTableProps
...
interface CoinDetailsData { //exactly what we ve seen from the coingecko api doc 54:40
  id: string;
  name: string;
  symbol: string;
...
interface DataTableProps<T> { //31:40
  columns: DataTableColumn<T>[];
  data: T[];
  rowKey: (row: T, index: number) => React.Key;
  tableClassName?: string; //optioonal - type string
  headerClassName?: string;//optioonal - type string
  headerRowClassName?: string;//optioonal - type string
  headerCellClassName?: string;//optioonal - type string
  bodyRowClassName?: string;//optioonal - type string
  bodyCellClassName?: string;//optioonal - type string
}
